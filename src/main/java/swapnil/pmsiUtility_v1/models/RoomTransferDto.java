...
public class RoomTransferDto {
    ...
    @NotBlank(message = "isSharer for oldRoom is required")
    private boolean isSharerForOldRoom;

    @NotBlank(message = "isSharer for newRoom is required")
    private boolean isSharerForNewRoom;
